...
function updateProfile(data) {
  if (data.message !== "Not Found") {
    noresults.style.display = "none";
    function checkNull(aman1, aman2) {
      if (aman1 === "" || aman1 === null) {
        aman2.style.opacity = 0.5;
        aman2.previousElementSibling.style.opacity = 0.5;
        return false;
      } else {
        return true;
      }
...
// const prefersDarkMode = window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches;
  ...
  //by default, Meri github info show kqrega UI pr
  getUserData(url + "CATALYSTAMAN");
}
